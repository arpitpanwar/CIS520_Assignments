\section{Sensational EM \hpoints{20}}
...
\item \points{4} (M-step for $\mu$) Given the estimates of the
...
\item \points{4} (M-step for $\pi_0$) Given the estimates of the
...
\item \points{4} Suppose we will now apply our EM procedure to the
